...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //on below line we are creating an sqlite query and we are setting our column names
    ...
    public ArrayList<CourseModal> readCourses() {
        //on below line we are creating a databse for reading our database.
        ...
        if (cursorCourses.moveToFirst()) {
            do {
                ...
                courseModalArrayList.add(new CourseModal(cursorCourses.getString(1), cursorCourses.getString(4), cursorCourses.getString(2), cursorCourses.getString(3)));
    ...
    public void deleteCourse(String courseName) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        //on below line we are calling a method to delete our course and we are comparing it with our course name.
